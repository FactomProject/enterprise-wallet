...
$pageTitle = 'Edit Entry Credit Address';
...
<div class="row">
                        <div class="columns">
                            ...
                            <h1>Edit Entry Credit Address</h1>
                            <form>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="medium-8 columns">
                                        <input type="text" disabled="true" name="public-key" value="EC2iH4u6cvTEac94PggP66rtM61NS3mURshXcPH6UwUQ5Mpoxch8">
                                    </div>
                                    <div class="medium-4 columns">
                                        <input type="text" name="alias" value="entrycredit1">
                                    </div>
                                </div>
                                <div class="row">
