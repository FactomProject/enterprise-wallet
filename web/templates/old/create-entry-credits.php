...
$pageTitle = 'Create Entry Credits';
$mainClass = 'create-entry-credits';
$activeNav = 1;
                        ...
                        <div class="columns">
                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="small-12 medium-7 large-8 columns">
                                        <div class="input-group">
                                            <input type="text" name="output1" class="input-group-field" placeholder="Type entry credit address">
                                            <a data-toggle="addressbook" class="input-group-button button"><i class="fa fa-book"></i></a>
                                        </div>
                                    </div>
                                    <div class="small-10 medium-4 large-3 columns">
                                        <div class="input-group">
                                            <input type="text" class="input-group-field" name="output1-num" placeholder="Amount of entry credits">
                                ...
                                <div class="row">
                                    ...
                                    <div class="small-10 medium-4 large-3 columns">
                                        <a href="#" class="button expanded">Convert to Entry Credits</a>
                                    </div>
                                    <div class="small-2 medium-1 columns">
